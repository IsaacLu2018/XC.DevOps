...
namespace GetModel
{
    class Program
    {
        static void Main(string[] args)
        {
             ...
             * 2.Scaffold-DbContext "Data Source=172.16.8.7;port=3306;Database=hz_xc_devops;User ID=root;Password=p@ssw0rd;CharSet=utf8;" -Provider "Pomelo.EntityFrameworkCore.MySql" -OutputDir DevOpsModelsV2 
